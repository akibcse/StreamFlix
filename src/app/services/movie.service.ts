...
export class MovieService {
  ...
  getTrendingTv(timeWindow: 'day' | 'week' = 'week'): Observable<PaginatedResponse<MediaItem>> {
    return this.http
      .get<PaginatedResponse<MediaItem>>(`${this.baseUrl}/trending/tv/${timeWindow}`, { params: this.getParams() })
